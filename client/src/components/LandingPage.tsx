...
import { CloudRain, Zap } from 'lucide-react'; // Restoring the icons
    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center relative overflow-hidden text-white font-sans">
      ...
      <div className="z-10 flex flex-col items-center space-y-10">
        ...
        <div className="flex flex-col items-center gap-2 animate-in fade-in zoom-in duration-1000">
          ...
          <h1 className="text-6xl font-black tracking-tighter bg-gradient-to-r from-blue-200 via-white to-blue-200 bg-clip-text text-transparent mt-4">
            AtmosCheck
          </h1>
        ...
        <div className="w-full max-w-[400px] relative group animate-in slide-in-from-bottom-8 fade-in duration-1000 delay-300">
          <input
            ...
            className="w-[400px] bg-white/5 border border-white/10 rounded-full px-6 py-4 text-xl text-center outline-none focus:bg-white/10 focus:border-blue-400/50 transition-all placeholder:text-white/20 shadow-2xl"
          />
